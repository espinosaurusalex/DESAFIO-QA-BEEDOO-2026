...
#  Observação :  deixei os bugs somente no github pois acredito que seja melhor por conta das descrições pedidas conforme o formulário. 
Mas todos os testes negativos se encontram no vídeo que coloquei acima no cenários negativos. 
